      ...
      {groups.length === 0 ? (
        <div className="py-20 text-center">
          ...
          <p className="text-trove-muted">
            {user?.is_guest
              ? "Guest accounts can't create or join groups. Sign in with Google to get started."
              : 'No groups yet. Create one, or ask someone to send you an invite link.'}
          </p>
        </div>
      ) : (
